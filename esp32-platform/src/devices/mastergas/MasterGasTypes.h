...
//
//  GPIO36/39 — вход-онли пины ESP32, что и требуется для чистого
//  RX. Совпадает с назначением на схеме платы.
// ============================================================
#define MASTERGAS_BOILER_RX_PIN  39   // boilerRead  (вход-онли)
#define MASTERGAS_REMOTE_RX_PIN  36   // remoteRead  (вход-онли)
